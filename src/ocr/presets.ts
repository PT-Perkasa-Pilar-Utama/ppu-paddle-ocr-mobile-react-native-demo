 ...
 * entry is the library default (PP-OCRv6 tiny since 6.2.0).
 */
export const MODEL_CHOICES: ModelChoice[] = [
  { key: "v6-tiny", label: "v6 tiny", note: "Default · fastest", model: V6_TINY_MODEL },
  { key: "v6-small", label: "v6 small", note: "Full dictionary · balanced", model: V6_SMALL_MODEL },
